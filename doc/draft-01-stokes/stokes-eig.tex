...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\abstract{The boundary integral equation (BIE) framework
  provides robust and scalable eigenvalue computations, which
  owes to the fact that only the boundary of the domain
  must be discretized and that there is no high frequency
  ``pollution'' when using a Green's function to analytically
  represent the propagation of oscillatory waves.
  %
  ...
  discretizing BIEs and fast linear algebra,
