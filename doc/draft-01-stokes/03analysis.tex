...
%
We first define a radiation condition for the oscillatory
Stokes equations and prove that, under certain assumptions, the
layer potentials satisfy the radiation condition.
%
The radiation condition is then key to proving uniqueness
results for some common boundary value problems on exterior
domains.
%
With the Fredholm alternative, these uniqueness results
are sufficient to derive the invertibility of appropriate
...
field $\bu$. The normal component of the stress,
\begin{equation}
\bt = \bsigma \cdot \bnu \; , \nonumber
\end{equation}
