...
and are flexible both with respect to the governing
...
like $h^4$ where $h$ is the diameter of a typical element
...
\cref{eq:buck2,buck3} results in an integral equation
...
value or the determinant, converge to zero for all values of
$k^2$ as the boundary is refined.

Second kind integral equations, i.e. equations in which the
