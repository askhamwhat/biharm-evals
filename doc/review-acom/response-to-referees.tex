...
is directly proportional to the quadrature error for evaluating
the convolution of the integral kernel with the true null vector
of the integral operator with $k$ corresponding to that eigenvalue.
