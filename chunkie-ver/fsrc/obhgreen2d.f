...
cc it under the terms of the BSD-3-Clause License
      ...
      subroutine obhgreenall(zk,zx,zy,ifpot,pot,ifgrad,grad,
...
c     evaluate potential and derivatives
     ...
     3        (45.0d0*dx4*dy-60.0d0*dx2*dy3)*ders(1)/r4)/r5
      ...
      subroutine obhgreen(zk,zx,zy,ifpot,pot,ifgrad,grad,
     1     ifhess,hess)
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
c
...
c     local variables
      ...
      call obhgreenall(zk,zx,zy,ifpot,pot,ifgrad,grad,
     1     ifhess,hess,ifder3,der3,ifder4,der4,ifder5,der5)

      return
      end

      subroutine obhgreend1(zk,zx,zy,ifpot,pot,ifgrad,grad,
     1     ifhess,hess,dir1)
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
c
...
c     local variables
      ...
      call obhgreenall(zk,zx,zy,ifpotloc,potloc,ifgradloc,gradloc,
     1     ifhessloc,hessloc,ifder3,der3,ifder4,der4,ifder5,der5)
      ...
      subroutine obhgreend2(zk,zx,zy,ifpot,pot,ifgrad,grad,
...
c     convert two directional derivatives to xx, xy, yy
      ...
      call obhgreenall(zk,zx,zy,ifpot1,potloc,ifgrad1,gradloc,
