...
ccccccccccccccccccccccccccccccccccccccccccccccccccccc      
     ...
     1      verts,ifclosed,nover,k,nch,chunks,adjs,ders,ders2,hs)
      ...
      call chunksort(k,nch,chunks,adjs,ders,ders2,hs)
...
c
      ...
      xt = targ(1,i)
      yt = targ(2,i)
      call pnpoly(xt,yt,xs,ys,nnn,isint(i))

      do ib = 2,ncomp

      rr = (xt-cms(1,ib))**2 + (yt-cms(2,ib))**2
      if(rr.le.rad**2) isint(i) = ib + 100
