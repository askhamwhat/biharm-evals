...
c
c
        subroutine cgmres(ier,n,a,multa,p1,p2,p3,p4,y,eps,numit,
...
c
        ...
        lzr=n
c
        call cgmres1(ier,n,a,multa,p1,p2,p3,p4,y,eps,numit,x,niter,errs,
...
c
c
        subroutine cgmres1(ier,n,a,multa,p1,p2,p3,p4,y,eps,numit,
...
c
        call multa(a,p1,p2,p3,p4,x,z,n)
c
        do 1200 i=1,n
        z(i)=y(i)-z(i)
 1200 continue
...
c
        call multa(a,p1,p2,p3,p4,z,w,n)
c
...
c
c
        subroutine cgmrespp(w,ngmrec,nvec,n,ainv,a,multb,
     $     p5,p6,p7,p8,aw)
        implicit real *8 (a-h,o-z)
        complex *16 w(n,ngmrec,1),ainv(n,n),a(n,n),aw(1),alpha
c
        external multb
c
...
c
        do 2600 k=1,nvec
c       
        call multb(a,p5,p6,p7,p8,w(1,k,2),aw,n)
c       
        do 2400 i=1,n
        do 2200 j=1,n
...
c
        ...
        implicit real *8 (a-h,o-z)
        complex *16 w(n,ngmrec,1),ainv(n,n),a(n,n),alpha
c
c       This subroutine finds the inverse (or an approximation of the
c       inverse) of the matrix a by using the rank-1 updates of the UNIT
c       matrix, as contructed via a preceding call to cgmres.
...
c
c
        subroutine cgmrespv(w,ngmrec,nvec,n,a,multb,p5,p6,p7,p8,aw)
        implicit real *8 (a-h,o-z)
        complex *16 w(n,ngmrec,1),a(n,n),aw(1),alpha
c
        external multb
c
...
c
        ...
        implicit real *8 (a-h,o-z)
        complex *16 w(n,ngmrec,1),x(1),y(1),d,alpha
c
        alpha=1
c       
        do 1200 i=1,n
